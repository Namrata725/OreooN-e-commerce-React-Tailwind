  ...
  return (
    <section>
      <div className="max-w-[1400px] px-10 mx-auto py-20">
        <Heading orange="Customers" normal="Testimonials" />
        <div className="py-5 flex justify-end gap-x-3">
          <button className="custom-prev text-2xl text-zinc-800 rounded-lg size-11 flex bg-zinc-100 justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer">
            <IoIosArrowBack />
          </button>
          <button className="custom-next text-2xl text-zinc-800 rounded-lg size-11 flex bg-zinc-100 justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer">
            <IoIosArrowForward />
          </button>
        </div>
